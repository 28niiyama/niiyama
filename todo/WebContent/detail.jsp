...
<body>
<form id="sender" action="RegisterServlet" method="POST">
<table border="1">
	<tr>
	 <th>番号</th>
	 <td width="60">
	...
	<tr>
	 	<th>期限</th>
	 	<td><input type="text" name="limitdate" value="<fmt:formatDate value="${vo.limitdate}" pattern="yyyy-MM-dd"/>" size="16"/></td>
	</tr>
	<tr>
	 	<th>ユーザＩＤ</th>
